...
public class TestBtVEncoder {
    private static final String TAG = TestBtVEncoder.class.getSimpleName();
    ...
    public TestBtVEncoder(IBitmapToVideoEncoderCallback callback) {
        mCallback = callback;
    }
